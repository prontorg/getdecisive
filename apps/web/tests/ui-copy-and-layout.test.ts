...
test('training plan page uses the latest decisive monthly-planner framing and layout', async () => {
  ...
  assert.match(source, /<button type="submit" className="button-secondary button-link">Repair<\/button>/i);
  assert.match(source, /<button type="submit" className="button-secondary button-link">Too fatigued<\/button>/i);
  assert.match(source, /<button type="submit" className="button-secondary button-link">Race-like<\/button>/i);
