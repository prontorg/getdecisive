...
test('training plan page uses the latest decisive monthly-planner framing and layout', async () => {
  ...
  assert.match(source, /Evidence window/i);
  assert.match(source, /Excluded by filters/i);
  ...
  assert.match(source, /builderAnalysisCards/i);
  assert.match(source, /Planning snapshot/i);
  assert.match(source, /Strengths/i);
  assert.match(source, /Limiters/i);
  assert.match(source, /Goal direction/i);
  assert.match(source, /Adaptation state/i);
  ...
  assert.match(source, /Current-week rail/i);
